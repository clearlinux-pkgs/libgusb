...
Version  : 0.4.5
Release  : 20
URL      : https://github.com/hughsie/libgusb/archive/0.4.5/libgusb-0.4.5.tar.gz
Source0  : https://github.com/hughsie/libgusb/archive/0.4.5/libgusb-0.4.5.tar.gz
...
%prep
%setup -q -n libgusb-0.4.5
cd %{_builddir}/libgusb-0.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675895784
