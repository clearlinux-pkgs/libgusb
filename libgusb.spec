...
Source0  : https://github.com/hughsie/libgusb/archive/0.3.1/libgusb-0.3.1.tar.gz
...
%prep
%setup -q -n libgusb-0.3.1
cd %{_builddir}/libgusb-0.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575790025
...
cp %{_builddir}/libgusb-0.3.1/COPYING %{buildroot}/usr/share/package-licenses/libgusb/9a1929f4700d2407c70b507b3b2aaf6226a9543c
