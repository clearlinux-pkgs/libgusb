...
Source0  : https://github.com/hughsie/libgusb/archive/0.4.3/libgusb-0.4.3.tar.gz
...
%prep
%setup -q -n libgusb-0.4.3
cd %{_builddir}/libgusb-0.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671636890
