...
Source0  : https://github.com/hughsie/libgusb/archive/0.4.2/libgusb-0.4.2.tar.gz
...
%prep
%setup -q -n libgusb-0.4.2
cd %{_builddir}/libgusb-0.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666101472
