...
Version  : 0.4.4
Release  : 19
URL      : https://github.com/hughsie/libgusb/archive/0.4.4/libgusb-0.4.4.tar.gz
Source0  : https://github.com/hughsie/libgusb/archive/0.4.4/libgusb-0.4.4.tar.gz
...
%prep
%setup -q -n libgusb-0.4.4
cd %{_builddir}/libgusb-0.4.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675094137
