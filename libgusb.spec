...
Version  : 0.4.7
Release  : 22
URL      : https://github.com/hughsie/libgusb/archive/0.4.7/libgusb-0.4.7.tar.gz
Source0  : https://github.com/hughsie/libgusb/archive/0.4.7/libgusb-0.4.7.tar.gz
...
%prep
%setup -q -n libgusb-0.4.7
cd %{_builddir}/libgusb-0.4.7
pushd ..
cp -a libgusb-0.4.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696865117
