...
Source0  : https://github.com/hughsie/libgusb/archive/0.4.1/libgusb-0.4.1.tar.gz
...
%prep
%setup -q -n libgusb-0.4.1
cd %{_builddir}/libgusb-0.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664813874
