...
Source0  : https://github.com/hughsie/libgusb/archive/0.4.8/libgusb-0.4.8.tar.gz
...
%prep
%setup -q -n libgusb-0.4.8
cd %{_builddir}/libgusb-0.4.8
pushd ..
cp -a libgusb-0.4.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699373340
