...
%prep
%setup -q -n libgusb-0.3.2
cd %{_builddir}/libgusb-0.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578418056
...
cp %{_builddir}/libgusb-0.3.2/COPYING %{buildroot}/usr/share/package-licenses/libgusb/9a1929f4700d2407c70b507b3b2aaf6226a9543c
