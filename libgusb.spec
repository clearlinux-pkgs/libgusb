...
Source0  : https://github.com/hughsie/libgusb/archive/0.3.8/libgusb-0.3.8.tar.gz
...
%prep
%setup -q -n libgusb-0.3.8
cd %{_builddir}/libgusb-0.3.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633548923
...
cp %{_builddir}/libgusb-0.3.8/COPYING %{buildroot}/usr/share/package-licenses/libgusb/9a1929f4700d2407c70b507b3b2aaf6226a9543c
