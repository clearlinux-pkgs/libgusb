...
Version  : 0.3.6
Release  : 10
URL      : https://github.com/hughsie/libgusb/archive/0.3.6/libgusb-0.3.6.tar.gz
Source0  : https://github.com/hughsie/libgusb/archive/0.3.6/libgusb-0.3.6.tar.gz
...
%prep
%setup -q -n libgusb-0.3.6
cd %{_builddir}/libgusb-0.3.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615590188
...
cp %{_builddir}/libgusb-0.3.6/COPYING %{buildroot}/usr/share/package-licenses/libgusb/9a1929f4700d2407c70b507b3b2aaf6226a9543c
